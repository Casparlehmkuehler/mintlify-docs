...
<CardGroup cols={3}>
  ...
  <Card title="GPU Support" icon="chip">
...
<Tabs>
  ...
  <Tab title="GPU Workload" icon="rocket">
...
<AccordionGroup>
  ...
  <Accordion title="Google Container Registry (Coming Soon)" icon="google">
    <Note>This registry integration is coming soon and is not yet available.</Note>
  </Accordion>

  <Accordion title="GitHub Container Registry (Coming Soon)" icon="github">
    <Note>This registry integration is coming soon and is not yet available.</Note>
  </Accordion>
</AccordionGroup>
...
<Tabs>
  ...
  <Tab title="Storage Access (Coming Soon)" icon="database" disabled>
    <Note>Storage access functionality is coming soon and is not yet available.</Note>
  </Tab>
</Tabs>
...
<CardGroup cols={2}>
  <Card title="ML Training" icon="sparkles">
    ```python
  ...
  <Card title="Web Scraping" icon="link">
    ```python
    # Selenium automation
    {
...
<Tabs>
  <Tab title="Server-Sent Events" icon="play">
    ```python
    import sseclient
...
<Note>
  Need help? Contact support@lyceum.technology or check our [API Reference](/api-reference/introduction) for detailed specifications.
</Note>