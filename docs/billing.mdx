...
<CardGroup cols={3}>
  ...
  <Card title="No Hidden Fees" icon="check">
...
<Tabs>
  <Tab title="Dashboard" icon="window">
...
<AccordionGroup>
  <Accordion title="Execution History" icon="clock">
  ...
  <Accordion title="Usage Analytics" icon="chart">
...
<AccordionGroup>
  <Accordion title="How are credits calculated?" icon="dollar-sign">
  ...
  <Accordion title="Can I set spending limits?" icon="lock">
...
<CardGroup cols={2}>
  <Card title="Billing Support" icon="mail">
  ...
  <Card title="Documentation" icon="file-text">
    Visit our [API Reference](/api-reference/introduction) for detailed endpoint documentation
  </Card>
</CardGroup>